...
<div class="container-fluid">
  <div class="form-container">
      <form class="elegant-form" action="{{ route('iklan.dalam.insert') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
              ...
              <select id="program_id" class="form-control @error('program_id') is-invalid @enderror" name="program_id">
                  ...
                  @foreach ($program as $programs)
                      <option value="{{ $programs->id }}" {{ old('program_id') == $programs->id ? 'selected' : '' }}>
          ...
          <div class="form-group">
            ...
            <input type="text" name="link2" class="form-control @error('link2') is-invalid @enderror" value="{{ old('link2') }}">
            @error('link2')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
          ...
          <div class="status-switch">
              <input type="checkbox" id="statusSwitch" name="status" {{ old('status') ? 'checked' : '' }}>
