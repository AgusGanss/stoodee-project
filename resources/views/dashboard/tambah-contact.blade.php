...
<div class="container-fluid">
  <div class="form-container">
    <form class="elegant-form" action="{{ route('contact.insert') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <h2>Add Contact</h2>
      <div class="form-group image-input-group">
        <label for="gambar_program">Icon</label>
        <input type="file" id="gambar_program" name="icon" required>
      ...
      <div class="form-group">
        ...
        <textarea cols="80" id="ckeditor" name="contact"  class= "deskripsi @error('contact') is-invalid @enderror" rows="10"></textarea>
        @error('contact')
