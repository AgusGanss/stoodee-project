...
<div class="container-fluid">
  <div class="form-container">
      <form class="elegant-form" action="{{ route('iklan.insert') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <h2>Add Iklan Depan</h2>
          <div class="form-row">
              <div class="form-group image-input-group">
                  <label for="gambar_program">Image Iklan</label>
                  <input type="file" id="gambar_program" name="iklan_image" required>
          ...
          <div class="form-group">
              ...
              <textarea cols="80" id="ckeditor" name="text_iklan" class="deskripsi @error('text_iklan') is-invalid @enderror" rows="10" value="{{ old('text_iklan') }}"></textarea>
                    @error('text_iklan')
          ...
          <div class="form-group">
            ...
            <input type="text" name="link" class="deskripsi @error('link') is-invalid @enderror" value="{{ old('link') }}">
                  @error('link')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
        ...
        <div class="status-switch">
            <input type="checkbox" id="statusSwitch" name="status" checked>
